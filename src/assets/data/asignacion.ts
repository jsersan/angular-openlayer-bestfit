...
export const ciclos: Asignacion[] = [
  // INFORMÁTICA Y COMUNICACIONES - GRADO MEDIO (ACTUALIZADO)
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10137, 10248, 12053, 12108, 12345, 12497, 12648, 12982, 13456, 14010,
      14069, 14151, 14279, 14421, 15041, 15201, 15305, 15307, 15392, 15414,
      15628
    ],
    duracion: 2000
  },
  ...
  // INFORMÁTICA Y COMUNICACIONES - GRADO SUPERIOR
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10137, 10248, 12053, 12108, 12345, 12497, 12648, 12982, 13023, 13456,
      14010, 14069, 14151, 14279, 14421, 14899, 15041, 15201, 15305, 15307,
      15392, 15414
    ],
    duracion: 2000
  },
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10137, 10248, 12053, 12345, 12497, 12648, 12982, 13023, 13542, 14010,
      14069, 14279, 14421, 14899, 15041, 15201, 15305, 15414, 15392, 15628
    ],
    duracion: 2000
  },
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10137, 10248, 12053, 12108, 12345, 12497, 12648, 12982, 13023, 13542,
      14010, 14069, 14151, 14279, 14421, 14899, 15041, 15201, 15305, 15307,
      15392, 15414, 15628
    ],
    duracion: 2000
  ...
  // COMERCIO Y MARKETING - GRADO MEDIO
  {
    ...
    slugEuskera: 'merkataritza-jardueretako', // ✅ YA CORRECTO
    abr: 'AC',
    familiaCodigo: 'COM',
  ...
  },
  {
    ...
    slugEuskera: 'garraioa-eta-logistikako', // ✅ YA CORRECTO
    abr: 'TL',
    familiaCodigo: 'COM',
    familia: 'Comercio y Marketing',
    grado: 'Superior',
  ...
  // SERVICIOS COMERCIALES - FP BÁSICA
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10214, 13542, 14615, 14669, 15037, 12544, 13015, 13432, 14890, 14898,
      15224, 15069
    ], // Bermar, Gureak, Almi, Mikeldi, Bituritxa-Barakaldo, Mungia
    duracion: 2000
  },
  ...
  // SERVICIOS ADMINISTRATIVOS - FP BÁSICA
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10214, 13542, 14615, 14696, 15226, 12544, 12497, 13432, 13015, 14890,
      14891, 14893, 14896, 13658, 13660
    ], // CPFPB + IMFPB
    duracion: 2000
  },
  ...
  // COCINA Y RESTAURACIÓN - FP BÁSICA
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010, 14669, 13432, 12544, 15037, 13656, 14890, 14891, 14892, 14893,
      14894, 14898, 13656, 15794, 13536
    ],
    duracion: 2000
  },
  ...
  // ELECTRICIDAD Y ELECTRÓNICA - FP BÁSICA
  {
    ...
    slugEuskera: 'instalazio-elektriko-eta-automatikoen', // ✅ YA CORRECTO
    abr: 'EE-B',
    familiaCodigo: 'ELE',
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010, 14069, 14088, 14702, 14747, 14810, 15037, 15041, 12053, 12229, 12372, 12497,
      13432, 13456, 13542, 13622, 13023, 10248, 15112, 13540, 15069 
    ],
    duracion: 2000
  },
  ...
  // INFORMÁTICA Y COMUNICACIONES - FP BÁSICA
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10248, 12053, 12497, 12648, 12982, 13432, 14069,
      14279, 14421, 14810, 15041, 15305, 15307, 15392, 13540 
    ],
    duracion: 2000
  },
  ...
  // MANTENIMIENTO DE VIVIENDAS - FP BÁSICA
  {
    ...
    turno: 'Diurno',
    idiomas: ['ES', 'EU'],
    centros: [14890, 14891, 14892, 15794, 15069],
    duracion: 2000
  },
  ...
  // MANTENIMIENTO DE VEHÍCULOS - FP BÁSICA
  {
    ...
    slugEuskera: 'ibilgailuen-mantentze-lanetako', // ✅ YA CORRECTO
    abr: 'MV-B',
    familiaCodigo: 'TMV',
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010,14069, 14702, 15041, 15305,12053,12229,
      12372,13015,13023,13456,14279,15307,10248,12572 
    ],
    duracion: 2000
  },
  ...
  // ARTES GRÁFICAS - FP BÁSICA
  {
    ...
    slugEuskera: 'arte-grafikoak', // ✅ CORREGIDO (más simple)
    abr: 'AG-B',
    familiaCodigo: 'ARG',
  ...
  // PANADERÍA, REPOSTERÍA Y CONFITERÍA - FP BÁSICA
  {
    ...
    slugEuskera: 'okintza-gozogintza-eta-konfiteriako', // ✅ YA CORRECTO
    abr: 'PRC-B',
    familiaCodigo: 'INA',
  ...
  // OPERACIONES DE FABRICACIÓN DE PRODUCTOS FARMACÉUTICOS - FP BÁSICA
  {
    ...
    slugEuskera: 'produktuen-fabrikazioaren-eragiketak-farmaceutikoak-kosmetikoak',
    abr: 'OFPFCA-B',
    familiaCodigo: 'QUI',
    familia: 'Química',
    grado: 'Básico',
  ...
  // ELECTRICIDAD Y ELECTRÓNICA - GRADO SUPERIOR (ACTUALIZADO)
  {
    ...
    turno: 'Diurno',
    idiomas: ['ES', 'EU'],
    centros: [15305, 12053, 13015, 13023, 14069, 14702, 12229, 15307],
    duracion: 2000
  },
  {
    codcicl: 20004,
  ...
  // FABRICACIÓN MECÁNICA - GRADO MEDIO (NUEVO)
  {
    ...
    centros: [
      ...
      13456, 14010, 14069, 14279, 15307, 10248
    ],
    duracion: 2000
  },
  {
  ...
  // INSTALACIÓN Y MANTENIMIENTO - GRADO MEDIO
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14069, 14702, 15037, 15041, 15305, 12053, 12229, 12372, 12497, 13015,
      13023, 13456, 14010, 14279, 14899, 15307, 10248
    ],
    duracion: 2000
  },
  ...
  },
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14069, 14702, 15041, 15305, 12053, 12229, 12497, 13015, 13023, 13456,
      14010, 14279, 14899, 15307, 10248
    ],
    duracion: 2000
  },
  {
    ...
    slugEuskera: 'bero-produkzioko-instalazioen', // ✅ YA CORRECTO
    abr: 'IPC',
    familiaCodigo: 'IMA',
    familia: 'Instalación y Mantenimiento',
    grado: 'Medio',
...

  {
    ...
    slugEuskera: 'lanbide-arriskuen-prebentzioaren', // ✅ YA CORRECTO
    abr: 'PRP',
    familiaCodigo: 'IMA',
    familia: 'Instalación y Mantenimiento',
    grado: 'Superior',
  ...
  // TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS - GRADO MEDIO
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010, 14069, 14702, 15041, 15305, 12053, 12229, 12372, 13015, 13023,
      13456, 14279, 15307, 10248
    ], 
    duracion: 2000
  },
  // TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS - GRADO MEDIO (ACTUALIZADO)
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010, 14702, 15305, 12053, 12229, 12372, 13015, 13023, 14069, 14279,
      15307, 10248
    ], 
    duracion: 2000
  },
  ...
  // TRANSPORTE Y MANTENIMIENTO DE VEHÍCULOS - GRADO SUPERIOR
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      14010, 14069, 14702, 15305, 12053, 12372, 13015, 13023, 14279, 15307,
      10248
    ], 
    duracion: 2000
  },
  ...
  },
  {
    ...
    slugEuskera: 'hegazkinetako-sistema-elektroniko-eta-avionikoen-mantentze-lanetako',
    abr: 'MSEAA',
    familiaCodigo: 'TMV',
    familia: 'Transporte y Mantenimiento de Vehículos',
    grado: 'Superior',
  ...
  // MADERA, MUEBLE Y CORCHO - GRADO SUPERIOR (NUEVO)
  {
    ...
    slugEuskera: 'zura-eta-altzarien-ekoizpenaren-diseinua-eta-kudeaketako', // ✅ YA CORRECTO
    abr: 'DGPM',
    familiaCodigo: 'MMC',
    familia: 'Madera, Mueble y Corcho',
    grado: 'Superior',
  ...
  // MARÍTIMO PESQUERA - GRADO MEDIO (NUEVO)
  {
    ...
    slugEuskera: 'itsasontzien-makineriaren-mantentze-lanak-eta-kontrola', // ✅ CORREGIDO
    abr: 'MCMB',
    familiaCodigo: 'MAP',
    familia: 'Marítimo Pesquera',
    grado: 'Medio',
  ...
  // MARÍTIMO PESQUERA - GRADO SUPERIOR (NUEVO)
  {
    ...
    slugEuskera: 'itsas-garraioa-eta-goi-arrantzako',
    abr: 'TMPA',
    familiaCodigo: 'MAP',
    familia: 'Marítimo Pesquera',
    grado: 'Superior',
  ...
  // SANIDAD - GRADO MEDIO
  {
    ...
    slugEuskera: 'erizaintzako-laguntza-lanetako', // ✅ YA CORRECTO
    abr: 'CAE',
    familiaCodigo: 'SAN',
    familia: 'Sanidad',
    grado: 'Medio',
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      15628, 13255, 13556, 14069, 14088, 12229, 13432, 14301, 12108, 10349,
      15623, 12286, 10134
    ],
    duracion: 2000
  },
  ...
  // SANIDAD - GRADO SUPERIOR
  {
    ...
    slugEuskera: 'laboratorio-kliniko-eta-biomedikoko', // ✅ YA CORRECTO
    abr: 'LCB',
    familiaCodigo: 'SAN',
    familia: 'Sanidad',
    grado: 'Superior',
  ...
  },
  {
    ...
    slugEuskera: 'dietetikako', // ✅ YA CORRECTO
    abr: 'DIE',
    familiaCodigo: 'SAN',
    familia: 'Sanidad',
    grado: 'Superior',
  ...
  },
  {
    ...
    slugEuskera: 'aho-higieneko', // ✅ YA CORRECTO
    abr: 'HB',
    familiaCodigo: 'SAN',
    familia: 'Sanidad',
    grado: 'Superior',
  ...
  // SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD - GRADO MEDIO (ACTUALIZADO)
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10248, 12372, 13023, 14069, 14279, 14669, 14747, 15037, 15305, 15307,
      15414
    ], // Se añaden 15305 y 12372
    duracion: 2000
  },
  {
    codcicl: 300005,
  ...
  // SERVICIOS SOCIOCULTURALES Y A LA COMUNIDAD - GRADO SUPERIOR
  {
    ...
    idiomas: ['ES', 'EU'],
    centros: [
      10248, 12229, 13015, 13023, 13456, 14069, 14279, 14747, 15037, 15305,
      15307, 15414
    ],
    duracion: 2000
  },
  ...
  },
  {
    ...
    slugEuskera: 'animazio-soziokultural-eta-turistikoko', // ✅ YA CORRECTO
    abr: 'ASCT',
    familiaCodigo: 'SSC',
    familia: 'Servicios Socioculturales y a la Comunidad',
    grado: 'Superior',
  ...
  },
  {
    ...
    slugEuskera: 'postinprimaketa-eta-akabera-grafikoen', // ✅ YA CORRECTO
    abr: 'PAG',
    familiaCodigo: 'ARG',
    familia: 'Artes Gráficas',
    grado: 'Medio',
...

  {
    ...
    slugEuskera: 'irudi-laborategiko',
    abr: 'LI',
    familiaCodigo: 'IMS',
    familia: 'Imagen y Sonido',
    grado: 'Medio',
  ...
  // ACTIVIDADES FÍSICAS Y DEPORTIVAS - GRADO SUPERIOR
  {
    ...
    slugEuskera: 'gizarte-eta-kirol-animazioko-eta-irakaskuntzako',
    abr: 'EASD',
    familiaCodigo: 'AFD',
    familia: 'Actividades Físicas y Deportivas',
    grado: 'Superior',
  ...
  },
  {
    ...
    nomEuskera: 'Kirol-instalazioetarako sarbidea eta kontserbazioa',
    slugEuskera: 'kirol-instalazioetarako-sarbideko-eta-kontserbazioko',
    abr: 'ACID',
    familiaCodigo: 'AFD',
    familia: 'Actividades Físicas y Deportivas',
    grado: 'Superior',
  ...
  },
  {
    ...
    slugEuskera: 'lorezaintza-eta-loredenda', // ✅ YA CORRECTO
    abr: 'JF',
    familiaCodigo: 'AGA',
    familia: 'Agraria',
    grado: 'Medio',
  ...
  // QUÍMICA - GRADO SUPERIOR (ACTUALIZADO)
  {
    ...
    turno: 'Diurno',
    idiomas: ['ES', 'EU'],
    centros: [14702, 14279, 13456, 14069], // Se añaden 13456 y 14069
    duracion: 2000
  },
  {
    codcicl: 340002,
  ...
  // ELECTRICIDAD Y ELECTRÓNICA - GRADO SUPERIOR (ACTUALIZADO)
  {
    ...
    turno: 'Diurno',
    idiomas: ['ES', 'EU'],
    centros: [15305, 12053, 13023, 12497, 14069, 14702, 15307, 10248],
    duracion: 2000
  },
  ...
  // ELECTRICIDAD Y ELECTRÓNICA - GRADO MEDIO
  {
    ...
    slugEuskera: 'telekomunikazio-instalazioen', // ✅ YA CORRECTO
    abr: 'IT',
    familiaCodigo: 'ELE',
    familia: 'Electricidad y Electrónica',
    grado: 'Medio',
    ...
    turno: 'Diurno',
    idiomas: ['ES', 'EU'],
    centros: [14010, 14069, 14702, 12053, 15037, 12497, 13456, 13023, 10248],
    duracion: 2000
  },
